...
func printBanner(logger *output.Logger) {
	banner := `
   _____ _____  ______ _____   _____ _____  ______ __  __ _      _____ _   _ 
  / ____|  __ \|  ____|  __ \ / ____|  __ \|  ____|  \/  | |    |_   _| \ | |
 | |    | |__) | |__  | |  | | |  __| |__) | |__  | \  / | |      | | |  \| |
 | |    |  _  /|  __| | |  | | | |_ |  _  /|  __| | |\/| | |      | | | . ` + "`" + ` |
 | |____| | \ \| |____| |__| | |__| | | \ \| |____| |  | | |____ _| |_| |\  |
  \_____|_|  \_\______|_____/ \_____|_|  \_\______|_|  |_|______|_____|_| \_|
